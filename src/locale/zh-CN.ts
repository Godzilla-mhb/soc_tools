...
import localeIphone from '@/views/dashboard/iphone/locale/zh-CN'
import localeIp from '@/views/dashboard/ip/locale/zh-CN'
import localeBank from '@/views/dashboard/bank/locale/zh-CN'
